...
class IssuingAgency extends Model
{
    ...
    protected $table = 'document_issuing_agencies';
    ...
    {
        static::creating(fn (IssuingAgency $model) => $model->created_by = $model->updated_by = auth()->id());
        static::updating(fn (IssuingAgency $model) => $model->updated_by = auth()->id());
    }
    ...
    {
        return $this->hasMany(Document::class, 'issuing_agency_id');
    }
