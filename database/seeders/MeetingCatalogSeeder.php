...
class MeetingCatalogSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $meetingTypes = collect([
            ...
            ['name' => 'Họp đột xuất', 'description' => 'Cuộc họp xử lý tình huống phát sinh khẩn cấp.', 'status' => 'inactive'],
        ...
        foreach ([
            ...
            ['name' => 'Khối hỗ trợ', 'description' => 'Nhóm hỗ trợ hậu cần, kỹ thuật cho cuộc họp.', 'status' => 'inactive'],
        ] as $item) {
        ...
        foreach ([
            ...
            ['name' => 'Tài liệu tham chiếu', 'description' => 'Tài liệu phụ trợ cho quá trình nghiên cứu, đối chiếu.', 'status' => 'inactive'],
        ] as $item) {
        ...
        foreach ([
            ...
            ['name' => 'Pháp chế', 'description' => 'Tài liệu thuộc nhóm pháp lý, tuân thủ.', 'status' => 'inactive'],
        ] as $item) {
        ...
        foreach ([
            ...
            ['name' => 'Người kiểm duyệt', 'position' => 'Kiểm duyệt tài liệu', 'description' => 'Người rà soát trước khi phát hành tài liệu.', 'status' => 'inactive'],
        ] as $item) {
        ...
        foreach ([
            ...
            ['name' => 'Ban pháp chế', 'description' => 'Đơn vị thẩm tra, rà soát tuân thủ.', 'status' => 'inactive'],
        ] as $item) {
